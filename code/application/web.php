 ...
 * @package  LouCesWeb
 */
class LcesApplicationWeb extends JApplicationWeb
{
    /**
     * The "task".
     *
    ...
    protected function fetchModel()
    {
        ...
        return new LcesModelDefault(new JRegistry);
    }
    ...
    protected function fetchView(JModelBase $model)
    {
        ...
        $className = 'LcesView'.ucfirst($name).'View';

        if( ! class_exists($className))
        {
            $className = 'LcesViewDefaultView';
